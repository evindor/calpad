...
pub static UNITS: &[UnitDef] = &[
    ...
    unit!("sq_cm", &["sq cm", "sqcm", "square centimeter", "square centimeters"], UnitCategory::Area, 0.0001, "sq cm"),
    unit!("sq_m", &["sq m", "sqm", "square meter", "square meters", "m2"], UnitCategory::Area, 1.0, "sq m"),
    unit!("sq_km", &["sq km", "sqkm", "square kilometer", "square kilometers", "km2"], UnitCategory::Area, 1_000_000.0, "sq km"),
    ...
    unit!("cu_cm", &["cu cm", "cucm", "cb cm", "cbcm", "cubic centimeter", "cubic centimeters", "cm3"], UnitCategory::Volume, 0.000001, "cu cm"),
    unit!("cu_m", &["cu m", "cum", "cb m", "cbm", "cubic meter", "cubic meters", "m3"], UnitCategory::Volume, 1.0, "cu m"),
